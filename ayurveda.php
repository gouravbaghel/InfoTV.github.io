...
<html lang="en">
  <head>
    ...
    <style>
      .mainimg{
        ...
        background-image:linear-gradient(rgba(0,0,0,0.5), rgba(0,0,0,0.5)),url('images/ayurveda.jpg');
      }
      .mainimg h6{
        font-size:1.5rem;
        position:relative;
  ...
  <body>
    ...
    <div class="mainimg">
        <h6 class="text-white text-center">Welcome to <span class="text-danger"> Ayurveda Hub</span></h6>
    </div>

    <div class="container my-4">
      <h3 class="text-center my-4" id="category">Latest Blogs</h3>
<div class="row my-4">

<?php
  $sql = "SELECT * FROM `content` WHERE category='ayurveda'";
